...
<body>
    <div class="container">
        <h1>บุคลากร | <a href='mainpage.php'><span class='glyphicon glyphicon-home'></span></a> | <a href='addstaff.php'><span class='glyphicon glyphicon-plus'></span></a></h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ชื่อหรือรหัสบุคลากร" value="">
            <input type="submit">
        </form>
