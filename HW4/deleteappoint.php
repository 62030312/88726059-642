...
<body>
    <div class="container">
        <h1><a href='appoint.php'><span class='glyphicon glyphicon-arrow-left'></span></a> | ลบคำสั่งแต่งตั้ง</h1>
        ...
        <form action="deleteappoint.php" method="post">
